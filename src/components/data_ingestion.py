...
from src.data_access.proj1_data import VehicleInsuranceData


class DataIngesstion:
...
def initiate_data_indestion(self) -> DataIngestionArtifact:
    """
    ...
    try:
        ...
        logging.into("Got the data from mongdb")
